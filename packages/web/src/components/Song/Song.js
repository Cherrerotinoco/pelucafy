        ...
        <div className="flex-none sm:flex justify-around mas-w-full">
          <div className="items-center flex-col">
            ...
            <div className="flex px-2 pt-2  text-sm text-white  ">
              ...
              <div className="flex-1 flex-col inline-flex items-center mx-1">
                <button
                  className="flex-no-shrink bg-green-400 hover:bg-green-500 px-2 ml-1 py-2 text-xs shadow-sm hover:shadow-lg font-medium tracking-wider border-2 border-green-300 hover:border-green-500 text-white rounded-full transition ease-in duration-300"
                  type="button"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
